...
let requestURL = 'https://smccrindle.github.io/comp1073-10/js/i-scream.json';
...
function topFlavors(jsonObj){
    ...
    for (var i = 0; i < topFlavors.length; i++) {
        ...
        img.setAttribute('src', 'https://raw.githubusercontent.com/JayCBreak/COMP1073-Week-10/master/images/' + topFlavors[i].image);
